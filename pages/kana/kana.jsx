    ...
    <>
      <Layout>
        ...
        <div className={styles.buttons}>
          <Button href="/Hiragana" style={styles.button1}>
            Hiragana <br />
            （ひらがな）
          </Button>
          <Button href="/Katakana" style={styles.button1} >
            Katakana
            <br /> （カタカナ）
          </Button>
          <Button href="/Both" style={styles.button1}>
        ...
        <div className={styles.kanas}>
          <h1>Main kana</h1>
          <Button style={styles.button2} href="/kana">
            All
          </Button>
          <Button style={styles.button2} href="/kana">
            a i u e o | ア イ ウ エ オ
